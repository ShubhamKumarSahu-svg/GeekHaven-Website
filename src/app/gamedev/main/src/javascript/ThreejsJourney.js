...
export default class ThreejsJourney
{
    constructor(_options)
    {
        ...
        this.seenCount = window.localStorage.getItem('gameDevShowcaseSeenCount') || 0
        this.seenCount = parseInt(this.seenCount)
        this.shown = false
        this.traveledDistance = 0
        this.minTraveledDistance = (this.config.debug ? 5 : 75) * (this.seenCount + 1)
        this.prevent = !!window.localStorage.getItem('gameDevShowcasePrevent')
    ...
    setYesNo()
    {
        ...
        this.$yes.addEventListener('click', () =>
        {
            ...
            window.localStorage.setItem('gameDevShowcasePrevent', 1)
        })
...
//             'color: #705df2;'
//         )
        console.log('%cCurious dev detected...', 'color: #32ffce')
        console.log('%cWant to build games and interactive experiences with us?', 'color: #32ffce')
        console.log('%cJoin Geekhaven GameDev Wing 👉 https://geekhaven.iiita.ac.in/', 'color: #32ffce')
        console.log('%c— Geekhaven GameDev Wing', 'color: #777777')
    }
    ...
    start()
    {
        ...
        window.localStorage.setItem('gameDevShowcaseSeenCount', this.seenCount + 1)
    }
