    ...
    setList()
    {
        this.list = [
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://geekhaven.iiita.ac.in/#events',
                    x: - 4.8,
                    y: - 3.3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://geekhaven.iiita.ac.in/#workshops',
                    x: - 4.8,
                    y: - 2,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://geekhaven.iiita.ac.in/#bootcamps',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://geekhaven.iiita.ac.in/#creative',
                    x: - 4.8,
                    y: - 4,
                    halfExtents:
                    {
            ...
            // },
            {
                ...
                link:
                {
                    href: 'https://geekhaven.iiita.ac.in/#projects',
                    x: - 4.8,
                    y: - 3,
                    halfExtents:
                    {
            ...
            },
            {
                ...
                link:
                {
                    href: 'https://geekhaven.iiita.ac.in/#showcase',
                    x: - 4.8,
                    y: - 4.4,
                    halfExtents:
                    {
